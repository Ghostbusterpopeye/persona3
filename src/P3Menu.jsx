...
export default function P3Menu({ onNavigate }) {
  ...
  useEffect(() => {
    const onKey = (e) => {
      ...
      if (e.key === "Enter") { if (ITEMS[active].page === "github") { window.open("https://github.com/Ghostbusterpopeye", "_blank", "noopener,noreferrer"); } else { onNavigate?.(ITEMS[active].page); } }
    };
          ...
          {ITEMS.map((item, i) => {
            ...
            return (
              <a
                ...
                onClick={(e) => { e.preventDefault(); if (item.page === "github") { window.open("https://github.com/Ghostbusterpopeye", "_blank", "noopener,noreferrer"); } else { onNavigate?.(item.page); } }}
